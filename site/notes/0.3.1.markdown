...
Scales 0.3.1 adds the following axe:
...
Scales 0.3.1 moves to Sonatype under the organisation org.scalesxml, with support for 2.8.1, 2.8.2, 2.9.1, 2.9.2 and 2.10.0-M6.  As such add:
