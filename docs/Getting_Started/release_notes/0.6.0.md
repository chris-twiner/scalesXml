...
will bring in shadowing functions already defined within Trampoline, allowing better type inference (you may need to have the imports at different scopes to properly shadow).

!!! info "Diverging implicit expansion for type scalaz.."
    In order to ensure the type derivation is correct for the implicits you are best defining them at the use site directly e.g.:
